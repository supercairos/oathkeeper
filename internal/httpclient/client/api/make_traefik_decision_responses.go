...
func (o *MakeTraefikDecisionForbiddenBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
...
func (o *MakeTraefikDecisionInternalServerErrorBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
...
func (o *MakeTraefikDecisionNotFoundBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
...
func (o *MakeTraefikDecisionUnauthorizedBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
